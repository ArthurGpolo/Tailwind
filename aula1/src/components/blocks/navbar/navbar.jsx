            ...
            <div className="w-full flex flex-row py-2">
                ...
                <el-dropdown className="inline-block w-40">
                    ...
                    <el-menu anchor="bottom end" popover className="w-56 origin-top-right rounded-md bg-white shadow-lg outline-1 outline-black/5 transition transition-discrete [--anchor-gap:--spacing(2)] data-closed:scale-95 data-closed:transform data-closed:opacity-0 data-enter:duration-100 data-enter:ease-out data-leave:duration-75 data-leave:ease-in">
                        <div className="py-1">
                            <a href="#" className="block px-4 py-2 text-sm text-gray-700 focus:bg-gray-100 focus:text-gray-900 focus:outline-hidden">Account settings</a>
                            <a href="#" className="block px-4 py-2 text-sm text-gray-700 focus:bg-gray-100 focus:text-gray-900 focus:outline-hidden">Support</a>
                            <a href="#" className="block px-4 py-2 text-sm text-gray-700 focus:bg-gray-100 focus:text-gray-900 focus:outline-hidden">License</a>
                            <form action="#" method="POST">
                                <button type="submit" className="block w-full px-4 py-2 text-left text-sm text-gray-700 focus:bg-gray-100 focus:text-gray-900 focus:outline-hidden">Sign out</button>
                            </form>
                        </div>
                    </el-menu>
                </el-dropdown>
                ...
                <el-dropdown className="inline-block w-40">
                    <button className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900">
                        For Work
                        <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" className="-mr-1 size-5 text-gray-400">
                            <path d="M5.22 8.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 1 1 1.06 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 9.28a.75.75 0 0 1 0-1.06Z" clipRule="evenodd" fillRule="evenodd" />
                        </svg>
                ...
                <button className="inline-flex w-40 justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900">
                    Compare Plans
                </button>
                ...
                <button className="inline-flex ms-110 w-40 justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-bold text-gray-900">
                    My Grammarly
                    <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" className="-mr-1 size-5 text-gray-400">
                        <path d="M5.22 8.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 1 1 1.06 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 9.28a.75.75 0 0 1 0-1.06Z" clipRule="evenodd" fillRule="evenodd" />
                    </svg>
                ...
                <button className="inline-flex w-40 justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-bold text-white bg-emerald-800">
                    My Grammarly
                </button>
            </div>

            <div className="w-full flex felx-row py-3 bg-gray-200">

                <h1 className="font-bold ps-15 me-18 text-xl">Business</h1>

                <button className="inline-flex w-40 justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-bold text-gray-900">
                    Pricing
                </button>
