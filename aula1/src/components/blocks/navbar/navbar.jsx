        ...
        <>
            ...
            <div className="w-full">
                ...
                <div className="flex items-center justify-between px-4 lg:px-12 py-3">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="hidden lg:flex items-center gap-6">
                            ...
                            <el-dropdown>
                                <button className="flex font-light text-base">
                                    Why Grammarly
                    ...
                    <div className="hidden xl:flex items-center gap-10">
                        ...
                        <button className="bg-emerald-800 text-white px-4 py-2 rounded-md text-sm font-extrabold hover:bg-emerald-700 transition">
                            Start a Free Trial
                        </button>
                ...
                <div className="bg-gray-200 md:flex items-center px-12 gap-12 hidden">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center gap-4 px-4 lg:px-12 py-3">

                        <div className="flex flex-wrap gap-8 font-light text-base">
                            ...
                            <button className="font-light text-base">Learn</button>
                            <button className="font-light text-base">Security</button>
