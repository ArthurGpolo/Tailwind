export default function Navbar() {
    return (
        <>
            <div className="lg:flex lg:flex-row py-2">
                ...
                <button className="lg:flex w-40 justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-bold text-gray-900">
                    My Grammarly
                    <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" className="-mr-1 size-5 text-gray-400">
                        <path d="M5.22 8.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 1 1 1.06 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 9.28a.75.75 0 0 1 0-1.06Z" clipRule="evenodd" fillRule="evenodd" />
                    </svg>
                ...
                <button className="lg:flex w-40 justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-bold text-white bg-emerald-800">
                    My Grammarly
                </button>
            </div>

            <div className="lg:flex lg:flex-row w-full py-3 bg-gray-200">
                ...
                <el-dropdown className="inline-block w-40">
                    <button className="lg:flex w-full justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-semibold text-gray-900 ">
                        Solutions
                        <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" className="-mr-1 size-5 text-gray-400">
                            <path d="M5.22 8.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 1 1 1.06 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 9.28a.75.75 0 0 1 0-1.06Z" clipRule="evenodd" fillRule="evenodd" />
                        </svg>
