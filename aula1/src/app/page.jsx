...
export default function Home() {
  return (
    <>
    <div className="flex flex-col lg:flex-row bg-gray-950 justify-center items-center h-215 px-85">
      <div className="flex flex-col lg:flex-cols-1 bg-gray-950 justify-center items-center p-8">
